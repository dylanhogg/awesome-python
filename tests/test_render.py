...
def test_render_process():
    ...
    assert list(df.columns) == ["category", "githuburl", "featured", "links", "description",
                                "_repopath", "_reponame", "_stars", "_forks", "_watches", "_language",
                                "_homepage", "_description", "_organization", "_updated_at",
                                "_created_at", "_age_weeks", "_stars_per_week", "_topics",
                                "_last_commit_date", "_pop_contributor_count",
                                "_pop_contributor_orgs_len", "_pop_commit_frequency",
                                "_pop_updated_issues_count", "_pop_closed_issues_count",
                                "_pop_created_since_days", "_pop_updated_since_days",
                                "_pop_recent_releases_count", "_pop_recent_releases_estimated_tags",
                                "_pop_recent_releases_adjusted_count", "_pop_issue_count",
                                "_pop_comment_count", "_pop_comment_count_lookback_days",
                                "_pop_comment_frequency", "_pop_score"
                                ]
